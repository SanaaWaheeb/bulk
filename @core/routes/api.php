...
Route::group(['prefix'=> 'v1' ,'middleware' => ['setlang:frontend'] ],function(){
       ...
       // Login Register Routes
        ...
        Route::post('/send-login-otp', [LoginController::class, 'sendLoginOtp']);
        Route::post('/verify-login-otp', [LoginController::class, 'verifyLoginOtp']);
        // OTP-based register routes
        Route::post('/send-register-otp', [RegisterController::class, 'sendRegisterOtp']);
        Route::post('/verify-register-otp', [RegisterController::class, 'verifyRegisterOtp']);
  ...
  //=============================== USER DASHBOARD ROUTES =============================
     Route::group(['prefix' => 'user/','middleware' => 'auth:sanctum'],function (){
        ...
        Route::group(['prefix' => 'donation'],function(){
            ...
            Route::post('/cancel/{id}',[\App\Http\Controllers\Api\DonationPaymentController::class,'cancelDonation']); // إضافة هذا السطر

...
// Login OTP routes (add these new routes)
Route::post('/login/send-otp', [LoginController::class, 'sendLoginOtp'])->name('login.send.otp');
Route::post('/login/verify-otp', [LoginController::class, 'verifyLoginOtp'])->name('login.verify.otp');



Route::post('/register/send-otp', [RegisterController::class, 'sendRegisterOtp'])->name('register.send.otp');
Route::post('/register/verify-otp', [RegisterController::class, 'verifyRegisterOtp'])->name('register.verify.otp');

        ...
        <form action="<?php echo e(route('admin.navbar.settings')); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="home_page_navbar_button_status">
                    <strong><?php echo e(__('Button Show/Hide')); ?></strong>
                </label>
                <label class="switch">
            ...
            <div class="form-group">
                <label for="home_page_navbar_search_show_hide">
                    <strong><?php echo e(__('Search Show/Hide')); ?></strong>
                </label>
                <label class="switch">
                    <input type="checkbox" name="home_page_navbar_search_show_hide"
                           <?php if(!empty(get_static_option('home_page_navbar_search_show_hide'))): ?> checked <?php endif; ?>>
                    <span class="slider"></span>
                </label>
            </div>
            ...
            <div class="tab-content margin-top-20" id="nav-tabContent">
                ...
                <div class="form-group">
                    <label for="home_page_navbar_button_subtitle">
                        <?php echo e(__('Button Subtitle (AR)')); ?>
                ...
                <div class="form-group">
                    <label for="home_page_navbar_button_subtitle_en">
                        <?php echo e(__('Button Subtitle (EN)')); ?>

                    </label>
                    <input type="text"
                           name="home_page_navbar_button_subtitle_en"
                           class="form-control"
                           value="<?php echo e(get_static_option('home_page_navbar_button_subtitle_en')); ?>">
                </div>

                
                <div class="form-group">
                    <label for="home_page_navbar_button_title">
                        <?php echo e(__('Button Title (AR)')); ?>
                ...
                <div class="form-group">
                    <label for="home_page_navbar_button_title_en">
                        <?php echo e(__('Button Title (EN)')); ?>

                    </label>
                    <input type="text"
                           name="home_page_navbar_button_title_en"
                           class="form-control"
                           value="<?php echo e(get_static_option('home_page_navbar_button_title_en')); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <small class="text-danger">
                    <?php echo e(__('** If you dont have any custom url then please leave this field blank or provide a valid URL **')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bulk\@core\resources\views/backend/pages/navbar-settings.blade.php ENDPATH**/ ?>
    ...
    <div id="accordion-payment">
        ...
        <div class="card">
            <div class="card-header" id="senangpay_settings">
                <h5 class="mb-0">
                    <button class="btn btn-link" type="button"
                            ...
                            aria-expanded="false">
                        <span class="page-title"> <?php echo e(__('Senangpay Settings')); ?></span>
                    </button>
                </h5>
            </div>
            <div id="senangpay_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="payment-notice alert alert-warning">
                        <p><?php echo e(__('If your currency is not available in Senangpay, it will convert your currency value to MYR based on your currency exchange rate.')); ?></p>
                    </div>
                    <label for="paytm_gateway"><strong><?php echo e(__('Enable/Disable Senangpay')); ?></strong></label>
                    <label class="switch">
                        <input type="checkbox" name="senangpay_gateway"
                               <?php if(!empty(get_static_option('senangpay_gateway'))): ?>
                                   checked
                               <?php endif; ?> id="senangpay_gateway">
                        <span class="slider onff"></span>-
                    </label>
                </div>
                <div class="form-group">
                    <label for="senangpay_test_mode"><strong><?php echo e(__('Enable Test Mode For Senangpay')); ?></strong></label>
                    <label class="switch">
                        <input type="checkbox" name="senangpay_test_mode" <?php if(!empty(get_static_option('senangpay_test_mode'))): ?> checked <?php endif; ?> >
                        <span class="slider onff"></span>
                    </label>
                </div>
                <div class="form-group">
                    <label for="site_logo"><strong><?php echo e(__('Senangpay Logo')); ?></strong></label>
                    <div class="media-upload-btn-wrapper">
                        <div class="img-wrap">
                            <?php
                            ...
                            ?>
                            <?php if(!empty($senangpay_img)): ?>
                                <div class="attachment-preview">
                                    <div class="thumbnail">
                                        <div class="centered">
                                            <img class="avatar user-thumb" src="<?php echo e($senangpay_img['img_url']); ?>" alt="">
                                        </div>
                                    </div>
                                </div>
                                <?php  $senangpay_image_btn_label = __('Change Image'); ?>
                            <?php endif; ?>
                        </div>
                        <input type="hidden" id="senangpay_preview_logo"
                               name="senangpay_preview_logo"
                               value="<?php echo e(get_static_option('senangpay_preview_logo')); ?>">
                        <button type="button"
                                class="btn btn-info media_upload_form_btn"
                                data-btntitle="<?php echo e(__('Select Image')); ?>"
                                data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                                data-toggle="modal"
                                data-target="#media_upload_modal">
                            <?php echo e(__($senangpay_image_btn_label)); ?>

                        </button>
                    </div>
                    <small class="form-text text-muted"><?php echo e(__('allowed image format: jpg,jpeg,png,webp. Recommended image size 160x50')); ?></small>
                </div>
                <div class="form-group">
                    <label for="senangpay_set_merchant_id"><?php echo e(__('Set Merchant Id')); ?></label>
                    <input type="text" name="senangpay_set_merchant_id" id="senangpay_set_merchant_id" value="<?php echo e(get_static_option('senangpay_set_merchant_id')); ?>" class="form-control">
                </div>
                <div class="form-group">
                    <label for="senangpay_set_secret_key"><?php echo e(__('Set Secret Key')); ?></label>
                    <input type="text" name="senangpay_set_secret_key" id="senangpay_set_secret_key" value="<?php echo e(get_static_option('senangpay_set_secret_key')); ?>" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div id="iyzipay_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="payment-notice alert alert-warning">
                        <p><?php echo e(__('If your currency is not available in Iyzipay, it will convert your currency value to ["TRY", "USD", "EUR", "GBP", "IRR", "NOK", "RUB", "CHF"] based on your currency exchange rate.')); ?></p>
                    </div>
                    <label for="paytm_gateway"><strong><?php echo e(__('Enable/Disable Iyzipay')); ?></strong></label>
                    <label class="switch">
                        <input type="checkbox" name="iyzipay_gateway"
                               <?php if(!empty(get_static_option('iyzipay_gateway'))): ?>
                                   checked
                               <?php endif; ?> id="iyzipay_gateway">
                        <span class="slider onff"></span>-
                    </label>
                </div>
                <div class="form-group">
                    <label for="iyzipay_test_mode"><strong><?php echo e(__('Enable Test Mode For Iyzipay')); ?></strong></label>
                    <label class="switch">
                        <input type="checkbox" name="iyzipay_test_mode" <?php if(!empty(get_static_option('iyzipay_test_mode'))): ?> checked <?php endif; ?> >
                        <span class="slider onff"></span>
                    </label>
                </div>
                <div class="form-group">
                    <label for="site_logo"><strong><?php echo e(__('Iyzipay Logo')); ?></strong></label>
                    <div class="media-upload-btn-wrapper">
                        <div class="img-wrap">
                            <?php
                            ...
                            ?>
                            <?php if(!empty($iyzipay_img)): ?>
                                <div class="attachment-preview">
                                    <div class="thumbnail">
                                        <div class="centered">
                                            <img class="avatar user-thumb" src="<?php echo e($iyzipay_img['img_url']); ?>" alt="">
                                        </div>
                                    </div>
                                </div>
                                <?php  $iyzipay_image_btn_label = __('Change Image'); ?>
                            <?php endif; ?>
                        </div>
                        <input type="hidden" id="iyzipay_preview_logo"
                               name="iyzipay_preview_logo"
                               value="<?php echo e(get_static_option('iyzipay_preview_logo')); ?>">
                        <button type="button"
                                class="btn btn-info media_upload_form_btn"
                                data-btntitle="<?php echo e(__('Select Image')); ?>"
                                data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                                data-toggle="modal"
                                data-target="#media_upload_modal">
                            <?php echo e(__($iyzipay_image_btn_label)); ?>
                ...
                <div class="form-group">
                    <label for="iyzipay_set_secret_key"><?php echo e(__('Set Secret Key')); ?></label>
                    <input type="text" name="iyzipay_set_secret_key" id="iyzipay_set_secret_key" value="<?php echo e(get_static_option('iyzipay_set_secret_key')); ?>" class="form-control">
                </div>
                <div class="form-group">
                    <label for="iyzipay_set_api_key"><?php echo e(__('Set Api Key')); ?></label>
                    <input type="text" name="iyzipay_set_api_key" id="iyzipay_set_api_key" value="<?php echo e(get_static_option('iyzipay_set_api_key')); ?>" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div id="awdpay_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="payment-notice alert alert-warning">
                        <p><?php echo e(__('If your currency is not available in Awdpay, it will convert your currency value to ["USD", "EUR", "XOF"] based on your currency exchange rate.')); ?></p>
                    </div>
                    <label for="paytm_gateway"><strong><?php echo e(__('Enable/Disable Awdpay')); ?></strong></label>
                    <label class="switch">
                        <input type="checkbox" name="awdpay_gateway"
                               <?php if(!empty(get_static_option('awdpay_gateway'))): ?>
                                   checked
                               <?php endif; ?> id="awdpay_gateway">
                        <span class="slider onff"></span>-
                    </label>
                </div>
                <div class="form-group">
                    <label for="awdpay_test_mode"><strong><?php echo e(__('Enable Test Mode For Awdpay')); ?></strong></label>
                    <label class="switch">
                        <input type="checkbox" name="awdpay_test_mode" <?php if(!empty(get_static_option('awdpay_test_mode'))): ?> checked <?php endif; ?> >
                        <span class="slider onff"></span>
                    </label>
                </div>
                <div class="form-group">
                    <label for="site_logo"><strong><?php echo e(__('Awdpay Logo')); ?></strong></label>
                    <div class="media-upload-btn-wrapper">
                        <div class="img-wrap">
                            <?php
                            ...
                            ?>
                            <?php if(!empty($awdpay_img)): ?>
                                <div class="attachment-preview">
                                    <div class="thumbnail">
                                        <div class="centered">
                                            <img class="avatar user-thumb" src="<?php echo e($awdpay_img['img_url']); ?>" alt="">
                                        </div>
                                    </div>
                                </div>
                                <?php  $awdpay_image_btn_label = __('Change Image'); ?>
                            <?php endif; ?>
                        </div>
                        <input type="hidden" id="awdpay_preview_logo"
                               name="awdpay_preview_logo"
                               value="<?php echo e(get_static_option('awdpay_preview_logo')); ?>">
                        <button type="button"
                                class="btn btn-info media_upload_form_btn"
                                data-btntitle="<?php echo e(__('Select Image')); ?>"
                                data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                                data-toggle="modal"
                                data-target="#media_upload_modal">
                            <?php echo e(__($awdpay_image_btn_label)); ?>
                ...
                <div class="form-group">
                    <label for="awdpay_set_private_key"><?php echo e(__('Set Private Key')); ?></label>
                    <input type="text" name="awdpay_set_private_key" id="awdpay_set_private_key" value="<?php echo e(get_static_option('awdpay_set_private_key')); ?>" class="form-control">
                </div>
                <div class="form-group">
                    <label for="awdpay_set_logo_url"><?php echo e(__('Set Logo Url')); ?></label>
                    <input type="text" name="awdpay_set_logo_url" id="awdpay_set_logo_url" value="<?php echo e(get_static_option('awdpay_set_logo_url')); ?>" class="form-control">
                </div>
            </div>
        </div>
...
</div><?php /**PATH /home/u177601598/domains/bulk.com.sa/public_html/@core/resources/views/backend/general-settings/gateway-portion/credentials.blade.php ENDPATH**/ ?>
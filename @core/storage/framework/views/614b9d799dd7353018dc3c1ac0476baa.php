...
<div class="mail-container">
    ...
    <div class="main-content-wrap">
        ...
        <p><?php echo e(__('A payment from')); ?> <?php echo e(($data->cause)->title_ar); ?> <?php echo e(__('was successful. Donation Log ID')); ?> #<?php echo e($data->id); ?> </p>
            <br>
            <?php if(!empty($data->gift)): ?>
                <strong><?php echo e(__('(You will get donation gift very soon according your provided address)')); ?></strong>
            <?php endif; ?>
        <?php else: ?>
            <p><?php echo e(__('You get payment from')); ?> <?php echo e($data->name); ?> <?php echo e(__('For donation log ID') .'#'); ?> <?php echo e($data->id); ?>, <?php echo e(__('donated cause')); ?> <?php echo e(optional($data->cause)->title); ?> </p>
        <?php endif; ?>
        <div class="price-wrap"><?php echo e(amount_with_currency_symbol($data->totalPrice)); ?></div>
        <table>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo e(optional($data->cause)->title_ar ?? ''); ?></td>
            </tr>
            <tr>
                <td><?php echo e(__('Phone')); ?></td>
                <td>0<?php echo e($data->phone); ?></td>
            </tr>
            ...
            <tr>
                <td><?php echo e(__('TotalPrice')); ?></td>
                <td><?php echo e(amount_with_currency_symbol($data->totalPrice)); ?></td>
            </tr>
            <!--<tr>-->
...
<?php /**PATH /home/u177601598/domains/bulk.com.sa/public_html/@core/resources/views/mail/donation-payment-success.blade.php ENDPATH**/ ?>
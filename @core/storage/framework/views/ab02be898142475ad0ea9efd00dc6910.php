...
<?php $__env->startSection('page-title',     __('Contact')); ?>
                    ...
                    <?php $__currentLoopData = $all_contact_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="single-contact-item">
                                ...
                                <div class="content">
                                    <span class="title"><?php echo e($displayTitle); ?></span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="contact-info">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-title">
                                        ...
                                        <h4 class="title"><?php echo e($formTitle); ?></h4>
                                    </div>
                            ...
                            <form action="<?php echo e(route('frontend.contact.message')); ?>"
                                  method="POST"
                        ...
                        <div class="map-area mt-5 pt-5">
                            <div class="container-fluid p-0">
                                <div class="contact_map">
                                    <?php echo render_embed_google_map(
    ...
    <?php if(!empty(get_static_option('site_google_captcha_v3_site_key'))): ?>
        ...
        <script>
            grecaptcha.ready(function () {
                grecaptcha.execute("<?php echo e(get_static_option('site_google_captcha_v3_site_key')); ?>", {action: 'homepage'})
                    .then(function (token) {
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bulk\@core\resources\views/frontend/pages/contact-page.blade.php ENDPATH**/ ?>
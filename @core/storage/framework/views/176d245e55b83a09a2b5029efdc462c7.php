<?php if(auth()->check()): ?>
    <?php
        $route = auth()->guest() == 'admin' ? route('admin.home') : route('user.home.edit.profile');
    ?>
...
<?php endif; ?><?php /**PATH /home/u177601598/domains/bulk.com.sa/public_html/@core/resources/views/components/front-user-login-li.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('page-title',     __('About us')); ?>
                    ...
                    <div class="col-lg-12">
                        <div class="about-title-content margin-bottom-50">
                            <div class="section-title desktop-left">
                                <span><?php echo e($aboutSubtitle); ?></span>
                                <h3 class="title"><?php echo render_colored_text($aboutTitle); ?></h3>
                            </div>
                        ...
                        <div class="col-lg-7 offset-lg-5">
                            <div class="about-content">
                                <div class="section-title">
                                    <h3 class="title"><?php echo e($missionTitle); ?></h3>
                                    <div><?php echo $missionDesc; ?></div>
                                </div>
                                <div class="content">
                                    <ul>
                                        <?php $__currentLoopData = $missionIcons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            ?>
                                            <li>
                                                <i class="<?php echo e($icon); ?>"></i> <?php echo e($liTitle); ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-sm-11 col-11">
                        <div class="section-title b-top desktop-center padding-top-25 margin-bottom-55">
                            <span><?php echo e($whatSubtitle); ?></span>
                            <h2 class="title"><?php echo render_colored_text($whatTitle); ?></h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <?php $__currentLoopData = $whatIcons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="problem-single-item margin-bottom-30">
                                <div class="icon style-0<?php echo e($idx); ?>">
                                    <i class="<?php echo e($icon); ?>"></i>
                                </div>
                                <div class="content">
                                    <h4 class="title">
                                        <a href="<?php echo e($itemUrl); ?>"><?php echo e($itemTitle); ?></a>
                                    </h4>
                                    <p><?php echo e($itemDesc); ?></p>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        >
                            <?php $__currentLoopData = $all_team_members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if (isset($component)) { $__componentOriginal24f5715fc387042da6f7c1bb9295e360 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal24f5715fc387042da6f7c1bb9295e360 = $attributes; } ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal24f5715fc387042da6f7c1bb9295e360)): ?>
<?php $attributes = $__attributesOriginal24f5715fc387042da6f7c1bb9295e360; ?>
<?php unset($__attributesOriginal24f5715fc387042da6f7c1bb9295e360); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal24f5715fc387042da6f7c1bb9295e360)): ?>
<?php $component = $__componentOriginal24f5715fc387042da6f7c1bb9295e360; ?>
<?php unset($__componentOriginal24f5715fc387042da6f7c1bb9295e360); ?>
<?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bulk\@core\resources\views/frontend/pages/about.blade.php ENDPATH**/ ?>
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.scripts.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="site_google_analytics" id="site_google_analytics" cols="30" rows="10" class="form-control"><?php echo e(get_static_option('site_google_analytics')); ?></textarea>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u177601598/domains/bulk.com.sa/public_html/@core/resources/views/backend/general-settings/thid-party.blade.php ENDPATH**/ ?>
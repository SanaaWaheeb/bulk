...
<?php $__env->startSection('section'); ?>
        ...
        <div class="table-responsive">
                <table class="table table-striped">
                    <thead>
                    <tr>
                        <th scope="col"><?php echo e(__('معلومات الطلب')); ?></th>
                        <th scope="col"><?php echo e(__('تفاصيل السعر')); ?></th>
                        <th scope="col"><?php echo e(__('حالة الدفع')); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            <td scope="row">
                                <div class="user-dahsboard-order-info-wrap">
                                    ...
                                    <small class="d-block"><strong><?php echo e(__('رقم الطلب:')); ?></strong> #<?php echo e($data->id); ?></small>
                                    <small class="d-block"><strong><?php echo e(__('Quantity:')); ?></strong> <?php echo e($data->amount); ?></small>
                                    <small class="d-block"><strong><?php echo e(__('Addresss')); ?>: </strong><br> <?php echo $data->address; ?></small>
                                    <?php
                                    ...
                                    <!--        <?php if($key === 'agreeTerms'): ?> <?php continue; ?> <?php endif; ?>-->
                                    <!--        <small class="d-block">-->
                                    <!--            <strong class="text-dark"><?php echo e(ucfirst($key) . ' : '); ?></strong>-->
                                    <!--            <?php echo e(!is_object($field) ? $field : ''); ?>-->
                                    <!--        </small>-->
                                    <!--    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
                                    <!--<?php endif; ?>-->
                            ...
                            <td>
                                <div class="order-pricing-details">
                                    ...
                                    <div class="pricing-breakdown">
                                        <small class="d-block"><strong><?php echo e(('سعر المنتج:')); ?></strong> <?php echo e(amount_with_currency_symbol($unit_price)); ?></small>
                                        <small class="d-block"><strong><?php echo e(__('Quantity:')); ?></strong> <?php echo e($quantity); ?></small>
                                        <hr class="my-2">
                                        <strong class="d-block text-primary"><?php echo e(__('السعر الاجمالي:')); ?></strong>
                                        <strong class="d-block text-primary h6"><?php echo e(amount_with_currency_symbol($total_price)); ?></strong>
                                    </div>
                                    
                                    <?php if(!empty($data->shipping_cost)): ?>
                                        <small class="d-block mt-2"><strong><?php echo e(__('Shipping:')); ?></strong> <?php echo e(amount_with_currency_symbol($data->shipping_cost)); ?></small>
                                        <?php $final_total = $total_price + $data->shipping_cost; ?>
                                        <hr class="my-1">
                                        <strong class="d-block text-success"><?php echo e(__('Final Total:')); ?></strong>
                                        <strong class="d-block text-success h6"><?php echo e(amount_with_currency_symbol($final_total)); ?></strong>
                                    <?php endif; ?>
                                </div>
                            </td>
        ...
        <?php else: ?>
            <div class="alert alert-warning"><?php echo e(__('No Orders Found')); ?></div>
        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u177601598/domains/bulk.com.sa/public_html/@core/resources/views/frontend/user/dashboard/donations.blade.php ENDPATH**/ ?>
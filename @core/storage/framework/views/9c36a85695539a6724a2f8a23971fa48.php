...
<?php endif; ?>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <?php echo e($data->description_en); ?>     
                                <?php endif; ?>
                            </td>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description"
                              ...
                              cols="30"
                              rows="5"
                              placeholder="<?php echo e(__('Description (Arabic)')); ?>"></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description_en"
                              ...
                              cols="30"
                              rows="5"
                              placeholder="<?php echo e(__('Description (English)')); ?>"></textarea>
                </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.donations.category.new')); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="description_ar"><?php echo e(__('Description (Arabic)')); ?></label>
                ...
                <div class="modal-footer">
                    ...
                    <button id="submit"
                            type="submit"
                            class="btn btn-primary"><?php echo e(__('Submit')); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<?php endif; ?>
                ...
                $(document).on('click', '.category_edit_btn', function () {
                    ...
                    if (image) {
                        ...
                        modal.find('.media_upload_form_btn').text('<?php echo e(__("Change Image")); ?>');
                    } else {
                        modal.find('.media-upload-btn-wrapper .img-wrap').html('');
                        modal.find('.media-upload-btn-wrapper input[name="image"]').val('');
                        modal.find('.media_upload_form_btn').text('<?php echo e(__("Upload Image")); ?>');
                    }
                });
            });
        })(jQuery)
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bulk\@core\resources\views/backend/donations/donations-category.blade.php ENDPATH**/ ?>
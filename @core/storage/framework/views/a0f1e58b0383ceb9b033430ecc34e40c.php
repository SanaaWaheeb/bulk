...
<?php $__env->startSection('content'); ?>
    ...
    <div class="form-group">
        <label for="blog_page_read_more_btn_text"><?php echo e(__('Blog Read More Text (AR)')); ?></label>
        <input type="text"
               class="form-control"
    ...
    <div class="form-group">
        <label for="blog_page_read_more_btn_text_en"><?php echo e(__('Blog Read More Text (EN)')); ?></label>
        <input type="text"
               class="form-control"
               id="blog_page_read_more_btn_text_en"
               name="blog_page_read_more_btn_text_en"
               value="<?php echo e(get_static_option('blog_page_read_more_btn_text_en')); ?>">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text"
               ...
               id="blog_page_item"
               name="blog_page_item"
               value="<?php echo e(get_static_option('blog_page_item')); ?>"
               placeholder="<?php echo e(__('Post Items')); ?>">
        <small class="text-danger">
            <?php echo e(__('Enter how many post you want to show in blog page')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bulk\@core\resources\views/backend/blog/page-settings/blog.blade.php ENDPATH**/ ?>
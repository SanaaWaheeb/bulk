...
<div class="shotcontent-wrapper">
    <div class="cause-description-wrapper" style="position: relative;">
        ...
        <div class="btn-wrapper text-right mt-3">
            <a id="ReadMoreButton" class="btn btn-sm btn-primary" href="#"><?php echo e(__('Read More')); ?></a>
        </div>
    </div>
</div>
...
<?php /**PATH /home/u177601598/domains/bulk.com.sa/public_html/@core/resources/views/frontend/partials/donation-single/general-view.blade.php ENDPATH**/ ?>
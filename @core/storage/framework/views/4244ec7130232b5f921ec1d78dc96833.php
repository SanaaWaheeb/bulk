            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.home.five.rise.area')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="home_page_05_rise_area_heading_title" class="form-control"
                                           value="<?php echo e(get_static_option('home_page_05_rise_area_heading_title')); ?>">
                                </div>
                                <div class="form-group">
                                    <label><?php echo e(__('Button Text')); ?></label>
                                    <input type="text" name="home_page_05_rise_area_button_text" class="form-control"
                                           value="<?php echo e(get_static_option('home_page_05_rise_area_button_text')); ?>">
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u177601598/domains/bulk.com.sa/public_html/@core/resources/views/backend/pages/home/home-05/rise-area.blade.php ENDPATH**/ ?>
...
<head>
    <meta charset="UTF-8">
    <title><?php echo e(__('Payment Invoice')); ?></title>
    <style type="text/css">
        * {
...
<table width="100%" class="table-top">
    ...
    <tr>
        <td valign="top">
            ...
            <p><strong><?php echo e(__('Customer Email : ')); ?></strong><?php echo e($donation_details->email); ?></p>
        </td>
...
<table class="table-footer" width="100%">
    ...
    <tr>
        <td valign="top">
            <div>
                ...
                <p class="singleItems"><strong><?php echo e(__('Customer Name : ')); ?></strong><?php echo e($donation_details->name); ?></p>
   ...
   <h6 class="singleItems" style="margin-bottom: 10px; display: block">
    <strong><?php echo e(__('Quantity : ')); ?></strong> <?php echo e($donation_details->amount ?? 1); ?>

</h6>

<h6 class="singleItems" style="margin-bottom: 10px; display: block">
    <strong><?php echo e(__('Unit Price : ')); ?></strong> <?php echo e(amount_with_currency_symbol($donation_details->price ?? 0, true)); ?>

</h6>

<h2 class="border-top" style="margin-top: 20px;margin-bottom: 20px; display: block">
    <strong><?php echo e(__('Total Amount : ')); ?></strong> <?php echo e(amount_with_currency_symbol(($donation_details->price ?? 0) * ($donation_details->amount ?? 1), true)); ?>
...
<?php /**PATH /home/u177601598/domains/bulk.com.sa/public_html/@core/resources/views/invoice/donation.blade.php ENDPATH**/ ?>
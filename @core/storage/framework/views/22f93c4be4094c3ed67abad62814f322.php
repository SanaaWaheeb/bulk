...
<?php endif; ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blog-category-edit')): ?>
                                                <a href="#"
                                                   ...
                                                   data-name_en="<?php echo e($data->name_en); ?>"
                ...
                <form action="<?php echo e(route('admin.blog.category')); ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo e(__('Name (Arabic)')); ?></label>
                            <input type="text"
                                   class="form-control"
                                   id="name"
                                   name="name"
                                   placeholder="<?php echo e(__('Name (Arabic)')); ?>">
                        </div>

                        
                        <div class="form-group">
                            <label for="name_en"><?php echo e(__('Name (English)')); ?></label>
                            <input type="text"
                                   class="form-control"
                                   id="name_en"
                                   name="name_en"
                                   placeholder="<?php echo e(__('Name (English)')); ?>">
                        </div>
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.blog.category.update')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_name"><?php echo e(__('Name (Arabic)')); ?></label>
                            <input type="text"
                                   class="form-control"
                                   id="edit_name"
                                   name="name"
                        ...
                        <div class="form-group">
                            <label for="edit_name_en"><?php echo e(__('Name (English)')); ?></label>
                            <input type="text"
                                   class="form-control"
                                   id="edit_name_en"
                                   name="name_en"

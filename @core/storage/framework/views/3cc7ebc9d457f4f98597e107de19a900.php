                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.donations.settings')); ?>" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="allow_user_to_add_custom_tip_in_donation" <?php if(!empty(get_static_option('allow_user_to_add_custom_tip_in_donation'))): ?> checked <?php endif; ?> >
                                    <span class="slider"></span>
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="transaction_minimum_charge_amount_type"><?php echo e(__('Transaction Fee Type')); ?></label>
                                <select class="form-control" name="transaction_minimum_charge_amount_type">
                                    <option value="fixed"
                                            <?php if(get_static_option('transaction_minimum_charge_amount_type') == 'fixed'): ?>  selected <?php endif; ?> ><?php echo e(__('Fixed Amount')); ?></option>
                                    <option value="percentage"
                                            <?php if(get_static_option('transaction_minimum_charge_amount_type') == 'percentage'): ?> selected <?php endif; ?>><?php echo e(__('Percentage Amount')); ?></option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="transaction_minimum_charge_amount"><?php echo e(__('Transaction Minimum Fee Amount')); ?></label>
                                <input type="text" name="transaction_minimum_charge_amount" class="form-control"
                                       value="<?php echo e(get_static_option('transaction_minimum_charge_amount')); ?>">
                            </div>
...
<div class="form-group">
    <label for="releated_donation_text"><?php echo e(__('Related Donation Text (Arabic)')); ?></label>
    <input type="text"
           name="releated_donation_text"
           class="form-control"
           id="releated_donation_text"
           value="<?php echo e(get_static_option('releated_donation_text')); ?>">
</div>


<div class="form-group">
    <label for="releated_donation_text_en"><?php echo e(__('Related Donation Text (English)')); ?></label>
    <input type="text"
           name="releated_donation_text_en"
           class="form-control"
           id="releated_donation_text_en"
           value="<?php echo e(get_static_option('releated_donation_text_en')); ?>">
</div>
                            ...
                            <div class="form-group">
                                <label for="donation_page_qr_code_title"><?php echo e(__('Qr Code Title')); ?></label>
                                <input type="text" class="form-control" name="donation_page_qr_code_title" value="<?php echo e(get_static_option('donation_page_qr_code_title')); ?>">
                            </div>
...
<?php endif; ?>
                            ...
                            <div class="form-group">
                                <label for="donation_terms_and_conditions"><?php echo e(__('Terms & Conditions')); ?></label>
                                <select class="form-control" name="donation_terms_and_conditions">
                                    ...
                                    <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($page->id); ?>" <?php if(get_static_option('donation_terms_and_conditions') == $page->id): ?>  selected <?php endif; ?> ><?php echo e(__($page->title)); ?></option>
                            ...
                            <div class="form-group">
                                <label for="donation_privacy_policy"><?php echo e(__('Privacy Policy')); ?></label>
                                <select class="form-control" name="donation_privacy_policy">
                                    <option value=""><?php echo e(__('Select Privacy Policy Pages to show')); ?></option>
                                    <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($page->id); ?>" <?php if(get_static_option('donation_privacy_policy') == $page->id): ?>  selected <?php endif; ?> ><?php echo e(__($page->title)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <span class="info-text"><?php echo e(__('you can create new pages if you do not have.')); ?></span>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="navbar_button"><?php echo e(__('Show/Hide Donate QR code')); ?></label>
                                <label class="switch">
                                    <input type="checkbox" name="donation_page_qr_code_show_hide"
                                           <?php if(!empty(get_static_option('donation_page_qr_code_show_hide'))): ?> checked <?php endif; ?> >
                                    <span class="slider"></span>
                                </label>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bulk\@core\resources\views/backend/donations/settings.blade.php ENDPATH**/ ?>
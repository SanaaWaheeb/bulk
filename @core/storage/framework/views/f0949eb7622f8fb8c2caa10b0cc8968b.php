                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($data->status == 'default'): ?>
                                            <span class="badge badge-success"><?php echo e(__('Global Default')); ?></span>
                                        <?php endif; ?>
                                        <?php if($data->status == 'default_en'): ?>
                                            <span class="badge badge-primary"><?php echo e(__('Default EN')); ?></span>
                                        <?php endif; ?>
                                        <?php if($data->status == 'default_ar'): ?>
                                            <span class="badge badge-warning"><?php echo e(__('Default AR')); ?></span>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('appearance-menu-manage-edit')): ?>
                                            <div class="d-flex flex-wrap" style="gap:6px;">
                                                
                                                <form action="<?php echo e(route('admin.menu.default.en',$data->id)); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" class="btn btn-outline-primary btn-sm mb-1"><?php echo e(__('Set Default (EN)')); ?></button>
                                                </form>
                                                <form action="<?php echo e(route('admin.menu.default.ar',$data->id)); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
                                                    <button type="submit" class="btn btn-outline-warning btn-sm mb-1"><?php echo e(__('Set Default (AR)')); ?></button>
                                                </form>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('appearance-menu-manage-delete')): ?>
                                            <?php if(!in_array($data->status, ['default','default_en','default_ar'])): ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bulk\@core\resources\views/backend/pages/menu/menu-index.blade.php ENDPATH**/ ?>
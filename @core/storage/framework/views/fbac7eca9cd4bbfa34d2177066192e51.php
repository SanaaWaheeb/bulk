                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.success.story.page.manage')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    <label><?php echo e(__('Success story single page share title')); ?></label>
                                    <input type="text" name="success_story_single_page_share_title" class="form-control"
                                           value="<?php echo e(get_static_option('success_story_single_page_share_title')); ?>">
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u177601598/domains/bulk.com.sa/public_html/@core/resources/views/backend/pages/success-story/page-manage.blade.php ENDPATH**/ ?>
...
@section('page-title')
    {{__('Payment Success For:')}} {{optional($donation_logs->cause)->title_ar}}
@endsection
@section('content')
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-lg-8 text-center">
                    <div class="success-header">
                        ...
                        <h1 class="success-title mb-3">{{get_static_option('donation_success_page_title')}}</h1>
                        <p class="success-description text-muted">{{get_static_option('donation_success_page_description')}}</p>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="donation-details">
                                        <div class="detail-item d-flex justify-content-between align-items-center py-3 border-bottom">
                                            ...
                                            <span class="detail-value fw-bold text-dark">{{$donation_logs->name}}</span>
                                        </div>
                                        ...
                                        <div class="detail-item d-flex justify-content-between align-items-center py-3 border-bottom">
                                            ...
                                            <span class="detail-value text-dark">{{$donation_logs->email}}</span>
                                        </div>
                                        ...
                                        <div class="detail-item d-flex justify-content-between align-items-center py-3 border-bottom">
                                            ...
                                            <span class="detail-value fw-bold text-dark">{{$donation_logs->amount}}</span>
                                        </div>
                                        ...
                                        <div class="detail-item d-flex justify-content-between align-items-center py-3 border-bottom">
                                            ...
                                            <span class="detail-value fw-bold text-dark">{{amount_with_currency_symbol($donation_logs->price)}}</span>
                                        </div>
                                        ...
                                        <div class="detail-item d-flex justify-content-between align-items-center py-4 bg-light rounded-3 mt-3">
                                            ...
                                            <span class="detail-value fw-bold text-success fs-4">{{amount_with_currency_symbol($donation_logs->totalPrice)}}</span>
                                        </div>
                                        ...
                                        @if(!empty($donation_logs->reward_point))
                                            <div class="detail-item d-flex justify-content-between align-items-center py-3 mt-3">
                                                ...
                                                <span class="detail-value">
                                                    <span class="badge bg-warning text-dark fs-6 px-3 py-2">{{$donation_logs->reward_point}}</span>
                                                </span>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="card-body p-4">
                                    <div class="navigation-options">
                                        <div class="button-group d-flex flex-column gap-3">
                                            ...
                                            <a href="{{url('/')}}" class="btn btn-outline-primary btn-lg shadow-sm">
                                            ...
                                            @if(auth()->guard('web')->check())
                                                ...
                                                <a href="{{url('user-home/donations')}}" class="btn btn-outline-primary btn-lg">
                                                    <i class="fas fa-shopping-bag me-2"></i>
                                                    {{__('View My Orders')}}
                                                </a>
                                            @endif
                                            
                                            <a href="{{route('frontend.donations.single',$donation->slug)}}" class="btn btn-outline-primary btn-lg">
                                                <i class="fas fa-arrow-left me-2"></i>
                                                {{__('Go back to the Product')}}
                                            </a>
                                        </div>
                                    </div>
                                </div>

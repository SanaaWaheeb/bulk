...
<table width="100%" class="table-top">
    ...
    <tr>
        <td valign="top">
            ...
            <p><strong>{{__('Customer Email : ')}}</strong>{{$donation_details->email}}</p>
        </td>
...
<table class="table-footer" width="100%">
    ...
    <tr>
        <td valign="top">
            <div>
                ...
                <p class="singleItems"><strong>{{__('Customer Name : ')}}</strong>{{$donation_details->name}}</p>
   ...
   <h6 class="singleItems" style="margin-bottom: 10px; display: block">
    <strong>{{__('Quantity : ')}}</strong> {{$donation_details->amount ?? 1}}
</h6>

<h6 class="singleItems" style="margin-bottom: 10px; display: block">
    <strong>{{__('Unit Price : ')}}</strong> {{amount_with_currency_symbol($donation_details->price ?? 0, true)}}
</h6>

<h2 class="border-top" style="margin-top: 20px;margin-bottom: 20px; display: block">
    <strong>{{__('Total Amount : ')}}</strong> {{amount_with_currency_symbol(($donation_details->price ?? 0) * ($donation_details->amount ?? 1), true)}}
</h2>
            </div>
        </td>
    </tr>

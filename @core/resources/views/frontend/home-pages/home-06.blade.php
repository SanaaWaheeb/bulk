...
<span class="targets"> {{ __('Amount Raised:') }} {{ number_format($donation_cause->raised, 2) }} </span>
                            </div>
...
<div class="goal">
    <h4 class="raised">{{ __('Raised') }}:  
        <span class="main-color-three">{{ number_format($data->raised ?? 0, 2) }}</span>
    </h4>
    <h4 class="raised">{{ __('Goal') }}: 
        <span class="danger-color">{{ number_format($data->amount, 2) }}</span>
    </h4>
</div>

...
@section('content')
    ...
    <div class="form-group">
        ...
        <input type="text"
               ...
               placeholder="{{__('Related Post Title (Arabic)')}}">
    </div>

    <div class="form-group">
        <label for="blog_single_page_related_post_title_en">
            {{__('Related Post Title (EN)')}}
        </label>
        <input type="text"
               class="form-control"
               id="blog_single_page_related_post_title_en"
               name="blog_single_page_related_post_title_en"
               value="{{ get_static_option('blog_single_page_related_post_title_en') }}"
               placeholder="{{__('Related Post Title (English)')}}">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text"
               ...
               placeholder="{{__('Tags Title (Arabic)')}}">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text"
               ...
               value="{{ get_static_option('blog_single_page_tags_title_en') }}"
               placeholder="{{__('Tags Title (English)')}}">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text"
               ...
               placeholder="{{__('Share Title (Arabic)')}}">
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text"
               ...
               value="{{ get_static_option('blog_single_page_share_title_en') }}"
               placeholder="{{__('Share Title (English)')}}">
    </div>

        ...
        <form action="{{route('admin.page.update',$page_post->id)}}" method="post"
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="page_content_en"
                       value="{{ $page_post->page_content_en ?? '' }}">
                <div class="summernote summernote-en"
                     data-content="{{ $page_post->page_content_en ?? '' }}"></div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    <x-fields.status
                        :name="'status'"
                        :title="__('Status')"
                        :value="$page_post->status"/>
                </div>
                <div class="form-group col-md-6">
                    <x-fields.page-show-type
                        :name="'visibility'"
                        :title="__('Visibility')"
                        :value="$page_post->visibility"/>
                </div>
            </div>

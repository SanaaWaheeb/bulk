...
class CauseLogs extends Model
{
    ...
    protected $fillable = ['cause_id','email','name','status','totalPrice','price','amount','transaction_id','payment_gateway','track','user_id','anonymous','admin_charge', 'transaction_fee'
